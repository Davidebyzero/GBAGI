@echo on
set path=H:\CODEX\GBAGI\DevKitAdv\bin;%PATH%

del gbagi.elf
del gbagi.bin

as -mthumb-interwork -o crt0.o crt0.s
as -mthumb-interwork -o sramhook.o sramhook.s
...
gcc -c -O3 -mthumb -mthumb-interwork -o lsl1hack.o lsl1hack.c
...
gcc -c -O1 -mthumb -mthumb-interwork -o saverestore.o saverestore.c
gcc -c -O3 -mthumb -mthumb-interwork -o interrupts.o interrupts.c

gcc -nostartfiles -Wl,-Tlnkscript -mthumb -mthumb-interwork -o gbagi.elf crt0.o sramhook.o extra/splashdata.o extra/splashlogodata.o main.o interrupts.o agimain.o gamedata.o input.o keyboard.o invobj.o logic.o lsl1hack.o picture.o screen.o status.o variables.o views.o system.o commands.o cmdagi.o cmdtest.o errmsg.o text.o menu.o parse.o saverestore.o wingui.o

objcopy -O binary gbagi.elf gbagi.bin

if exist gbarom\aginject.exe gbarom\aginject.exe
pause